...
So the campus bird list is not just a list of birds. It is also a list shaped by people. It records encounters between birds and observers, not birds alone.
...
```{r figure-ranking, fig.cap="**Figure 1.** Most frequently recorded bird groups on the UoA city campus, 2016–2026. Teal bars = native NZ species; salmon bars = introduced species. Tūī, a native honeyeater, appears almost as frequently as the House Sparrow despite being far less numerous on any urban campus.", out.width="92%"}
...
Australian Magpie moved up after the five most active observers were removed, probably because the groups around it lost proportionally more records from those observers. NZ Fantail and Kererū moved down, which suggests the opposite: their rankings may have depended more on records from highly active contributors. Both are native and distinctive enough to attract attention from regular or bird-interested observers, so their movement is a useful reminder that charismatic species can be especially sensitive to who is looking.
...
*AI use statement: Claude (Anthropic, claude-sonnet-4-6) assisted in generating the initial scaffold of the R Markdown analysis code, including structure for the GLM, GLMM, sensitivity analysis, and figure formatting. All analytical decisions, model structure, variable selection, and interpretation of results were made independently by the author. All code was reviewed, tested, and run by the author. This article was drafted independently, with AI assistance used only for a structural draft that the author then substantially rewrote and verified.*